...
function buildSystemPrompt(state) {
  ...
  return [
    ...
    "",
    "★ Q&A MODE — answering questions, not logging ★",
    "If the user ASKS a question about their spending rather than logging a spend or",
    "bill, reply in TALK mode with the answer. Cues that signal a question:",
    "  - starts with \"how much\", \"how many\", \"where\", \"what's my\", \"what did i\"",
    "  - starts with \"am i\", \"can i afford\" (afford uses ask_simulate)",
    "  - past-tense + total/sum framing: \"my coffee total\", \"my Lighthouse this month\"",
    "  - explicit period: \"last month\", \"this week\", \"in May\"",
    ...
    "    → { \"mode\":\"ask_simulate\", \"message\":\"Yes — $20 less/day after, still calm.\", \"amountCents\":20000 }",
    "",
