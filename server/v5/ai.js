...
function buildSystemPrompt(state) {
  ...
  return [
    ...
    '  record_spend    — { amountCents:N, note:"coffee", billKey?:"rent", originalAmountCents?:N, originalCurrency?:"VND" }',
    "                    For FOREIGN currencies (Vietnam dong, euros etc.): set originalAmountCents + originalCurrency to the user-spoken amount/code (e.g. 200000 ₫ + \"VND\"). Leave amountCents OUT or 0 — pipeline converts. Example: \"200000 dong on coffee\" → { amountCents: 0, originalAmountCents: 200000, originalCurrency: \"VND\", note: \"coffee\" }. Supported: USD EUR GBP RUB JPY VND AUD CAD INR CNY CHF SEK NOK PLN THB IDR MYR SGD HKD KRW TRY MXN BRL ZAR.",
