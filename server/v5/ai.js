...
function buildSystemPrompt(state) {
  ...
  return [
    ...
    "    2. ALWAYS need a dueDate. If user didn't give one, reply in TALK mode asking",
    "       (\"When do you need to pay?\" / \"By when?\"). DON'T guess silently.",
    "    3. MATCH EXISTING BILLS FIRST. Before emitting add_bill, check STATE.bills for",
    ...
    "    4. COMPOUND \"can I afford this commitment?\" — when user combines a commitment",
    ...
    "    5. CATEGORY on add_bill is encouraged when obvious (\"dry cleaning\" → \"personal\",",
