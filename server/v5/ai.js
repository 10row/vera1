...
function buildSystemPrompt(state) {
  ...
  return [
    ...
    "                    • Only set date when the user EXPLICITLY references a past time. Don't guess.",
    ...
    "                    • Examples — ALL include the params wrapper:",
    "                       \"i forgot to log $30 coffee yesterday\"     → params:{ amountCents:3000, note:\"coffee\", date:\"<yesterday>\" }",
    "                       \"spent 80 on groceries last saturday\"      → params:{ amountCents:8000, note:\"groceries\", date:\"<last sat>\", category:\"groceries\" }",
    "                       \"got a $100 refund yesterday\" (for spend)  → DO NOT use record_spend for refunds — refunds are talk-mode for now",
