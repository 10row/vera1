...
module.exports = {
  ...
  // The big number answers "can I afford this right now?" Pace + days
  ...
  "miniapp.hero.refWithBills": "{available} available · {balance} in account",
  "miniapp.hero.refNoBills": "{balance} in account",
