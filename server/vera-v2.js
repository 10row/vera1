...
function buildSystemPrompt(state) {
  ...
  const P = [
    ...
    "You show users what they CAN spend freely.",
    "Be warm, concise, never judgmental. Like a sharp friend who's great with money.",
    "",
    "CURRENT STATE:", snap, "",
    "TODAY: " + today(),
    "",
    ...
    "transaction: amountUSD (positive=spent, negative=refund), description",
    "add_drain: name, amountUSD, intervalDays (default 30), nextDate",
    "remove_drain: name",
    "confirm_payment: name (for due bills)",
    "add_pool: name, type ('daily'/'monthly'), dailyAmountUSD or allocatedUSD, keywords",
    "remove_pool: name",
    "add_planned: name, amountUSD, date",
    "remove_planned: name (cancel planned purchase)",
    "confirm_planned: name (bought it)",
    "income: amountUSD, description, nextPayday",
    "correction: amountUSD (sets new balance)",
    "set_saving_rate: rate (0 to 1, e.g. 0.1 = 10%)",
